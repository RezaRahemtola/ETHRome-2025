...
export const CONTRACT_ABI = [{
  ...
  "inputs": [{ "internalType": "address", "name": "_l2Registrar", "type": "address" }, {
    "internalType": "address",
    "name": "_l2Registry",
    "type": "address"
...
export const CONTRACT_ADDRESS = "0x1CA3A5ECA102932b3b846A93b26bce450ab14Dd2";
...
export const CONSTRUCTOR_ARGS = ["0x0A20Ab270Ac8Ffeb026fe5e57Ea31C2e58a686e0", "0xc02f3b4cbe3431a46a19416211aee7f004d829c3", "0xf8eb8832c80df1738b0aca49ffe0f4d8f134c83fb711e11be62cc4efa4555a82", "miniapp", BigInt(0)] as [`0x${string}`, `0x${string}`, `0x${string}`, string, bigint];
